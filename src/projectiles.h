...
public:
	...
	projectile() : loaded_object("", "", glm::vec3(0.1, 0.1, 0.1)) { //invisable projectile used for bot
...
public:
	...
	fragment() : loaded_object("objects/projectile.obj", "images/brick.jpg", glm::vec3(1.0f, 1.0f, 1.0f)){
		collision_check = false;
	}
